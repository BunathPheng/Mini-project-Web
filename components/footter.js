...
export const footter = () => {
  return `
      <section class="text-center mt-7 w-full">
        <h5 class="text-2xl font-bold">Follow Our Social Media</h5>
        <!-- TODO icon -->
        <div class="mt-7 text-[30px] flex justify-center items-center lg:gap-24 md:gap-24 min-[320px]:gap-20">
      ...
      <section class="mt-7 bg-yellow-600 w-full py-10">
        <!-- TODO company -->
        <div class="flex justify-between w-[85%] mx-auto flex-wrap gap-6">
